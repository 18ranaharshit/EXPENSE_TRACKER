<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=ExpenseIQ&fontSize=80&animation=fadeIn&fontAlignY=35"/>
...
*The financial command center designed for those who demand both power and aesthetics.*
...
## 🌐 Live Demo
<div align="center">
  <a href="https://expense-tracker-gray-omega.vercel.app/">
...
| :--- | :--- |
| **Students** | Track monthly allowances and manage meal/transport costs effortlessly. |
| **Freelancers** | Separate client payments from personal subscriptions and business costs. |
| **Savvy Savers** | Monitor monthly savings rates to hit major life goals faster. |
| **Techies** | Enjoy a modern, high-performance app that fits their dark-mode workspace. |
| **Gift Planners** | Set specific budgets for holidays or birthdays to stay on track. |
| **Spreadsheet Rebels** | Ditch the messy Excel files for a beautiful, automated dashboard. |

> [!IMPORTANT]
> **Perfect for Freelancers:** Keep your project income and software expenses in one clear view to make tax season a breeze.
...
| :--- | :--- |
| ![React](https://img.shields.io/badge/React-20232A?style=for-the-badge&logo=react) | Powers the interactive UI and handles all client-side state. |
| ![Node.js](https://img.shields.io/badge/Node.js-339933?style=for-the-badge&logo=nodedotjs&logoColor=white) | The backbone of the API, managing data flow and logic. |
| ![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=for-the-badge&logo=mongodb&logoColor=white) | Stores every transaction and user profile with high availability. |
| ![Passport](https://img.shields.io/badge/Passport-34E27A?style=for-the-badge&logo=passport&logoColor=white) | Orchestrates the Google OAuth flow and session security. |
| ![Recharts](https://img.shields.io/badge/Recharts-222222?style=for-the-badge&logo=recharts) | Renders the beautiful SVG charts that bring your data to life. |

<img src="https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/rainbow.png" />

## 🤓 Did You Know?
> [!NOTE]
> The entire dashboard is designed to run at 60fps, even when filtering through hundreds of transactions!

> [!TIP]
> The app uses a custom-tuned color palette designed to be perfectly readable in both dim and bright environments.
